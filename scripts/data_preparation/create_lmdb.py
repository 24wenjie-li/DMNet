...
def create_lmdb_for_div2k():
    ...
    # HR images
    folder_path = '/data/wenjieli/ntire_raindrop/DayNight_RainDrop_Train/Clear'
    lmdb_path = '/data/wenjieli/ntire_raindrop/DayNight_RainDrop_lmdb/Clear.lmdb'
    img_path_list, keys = prepare_keys_div2k(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # LRx2 images
    folder_path = '/data/wenjieli/ntire_raindrop/DayNight_RainDrop_Train/Blur_Drop'
    lmdb_path = '/data/wenjieli/ntire_raindrop/DayNight_RainDrop_lmdb/Blur_Drop.lmdb'
    img_path_list, keys = prepare_keys_div2k(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # LRx4 images
    # folder_path = '/data/wenjieli/dehaze_derain/All/All_train_LR_bicubic/X4'
    # lmdb_path = '/data/wenjieli/dehaze_derain/All_lmdb/All_train_LR_bicubic_X4.lmdb'
    # img_path_list, keys = prepare_keys_div2k_x4(folder_path)
    # make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # LRx3 images
    # folder_path = '/data/wenjieli/SISR_datasets/DF2K/DF2K_train_LR_bicubic/X3'
    # lmdb_path = '/data/wenjieli/SISR_datasets/DF2K_lmdb/DIV2K_train_LR_bicubic_X3.lmdb'
    # img_path_list, keys = prepare_keys_div2k_x3(folder_path)
    # make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # LRx4 images
    # folder_path = '/data/wenjieli/SISR_datasets/DF2K/DF2K_train_LR_bicubic/X4'
    # lmdb_path = '/data/wenjieli/SISR_datasets/DF2K_lmdb/DIV2K_train_LR_bicubic_X4.lmdb'
    # img_path_list, keys = prepare_keys_div2k_x4(folder_path)
    # make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)


    # # HR RealSRv3
    # folder_path = '/data/wenjieli/SISR_datasets/RealSRv3/Train/HR/X4_sub'
    # lmdb_path = '/data/wenjieli/SISR_datasets/RealSRv3_lmdb/RealSRv3_train_HR_sub.lmdb'
    # img_path_list, keys = prepare_keys_div2k(folder_path)
    # make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # # LRx4 RealSRv3
    # folder_path = '/data/wenjieli/SISR_datasets/RealSRv3/Train/LR/X4_sub'
    # lmdb_path = '/data/wenjieli/SISR_datasets/RealSRv3_lmdb/RealSRv3_train_LR_bicubic_X4_sub.lmdb'
    # img_path_list, keys = prepare_keys_div2k(folder_path)
    # make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)
...
def prepare_keys_div2k_x2(folder_path):
    """Prepare image path list and keys for DIV2K dataset.
...
def prepare_keys_div2k_x3(folder_path):
    """Prepare image path list and keys for DIV2K dataset.
    ...
    print('Reading image path list ...')
    img_path_list = sorted(list(scandir(folder_path, suffix='png', recursive=False)))
    keys = [img_path.split('x3.png')[0] for img_path in sorted(img_path_list)]

    return img_path_list, keys

def prepare_keys_div2k_x4(folder_path):
    """Prepare image path list and keys for DIV2K dataset.
    ...
    print('Reading image path list ...')
    img_path_list = sorted(list(scandir(folder_path, suffix='png', recursive=False)))
    keys = [img_path.split('x4.png')[0] for img_path in sorted(img_path_list)]
